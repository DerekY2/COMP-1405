''' 
    COMP 1005/1405 - Lecture 8 Rectangle draws a pygame rectangle
    Name: Sean Benjamin
    Date: October 2, 2024
'''
'''
...
'''
    ...
    The rectangle code has been modified from Dr. Robert Collier's example from 
...
# draw.rect(surface, colour_tuple, (left_top_X, left_top_Y, width, height))
pygame.draw.rect(drawing_window, (0, 220, 0), (100, 350, 200, 150))
...
pygame.image.save(drawing_window, "Lectures/L8/img/rectangle.png")